...
@WebFilter("/housekeepingstaff/*")
public class FilterHousekeeping implements Filter {
    @Override
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if (admin == null) {
            ...
            return;
        } else if (!"housekeeping".equals(admin.getRole().toLowerCase())) {
            response.sendRedirect("../" + IConstant.loginPage);
            return;
        } else if (!url.contains("/housekeepingstaff/")) {
