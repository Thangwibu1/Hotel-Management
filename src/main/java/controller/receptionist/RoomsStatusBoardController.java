 ...
 * @author trinhdtu
 */
@WebServlet(name = "RoomsStatusBoardController", urlPatterns = {"/RoomsStatusBoard"})
public class RoomsStatusBoardController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("/receptionist/roomStatusPage.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
