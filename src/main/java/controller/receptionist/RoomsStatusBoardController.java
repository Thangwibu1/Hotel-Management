 ...
 * @author trinhdtu
 */
@WebServlet(name = "RoomsStatusBoardController", urlPatterns = {"/receptionist/RoomsStatusBoard"})
public class RoomsStatusBoardController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("./roomStatusPage.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
