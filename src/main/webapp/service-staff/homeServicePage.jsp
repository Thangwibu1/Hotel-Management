...
<body>
    ...
    <div class="main-container">
        ...
        <div class="search-box">
            <input type="text" placeholder="? T�m ki?m kh�ch h�ng, ph�ng ho?c d?ch v?...">
        </div>

        <!-- Tabs -->
        <div class="tabs">
            <button class="tab active">+ Ghi nh?n d?ch v?</button>
            <button class="tab ">? C?p nh?t tr?ng th�i</button>
            <button class="tab">? B�o c�o</button>
        </div>
        ...
        <div class="card">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Nh?p t�n kh�ch h�ng">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>S? ph�ng *</label>
                        <input type="text" placeholder="V� d?: 101, 205A">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>T�n d?ch v? c? th? *</label>
                        <input type="text" placeholder="V� d?: Massage th? gi�n, B?a s�ng set">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea placeholder="Y�u c?u ??c bi?t, th�i quen mong mu?n..."></textarea>
            </div>
        ...
        <!-- Services List Card -->
        <div class="card">
            <div class="section-title">D?ch v? ?� ghi nh?n g?n ?�y</div>
            
            <div class="services-list">
                <div class="service-item">
                    <div class="service-icon" style="background: linear-gradient(135deg, #ffeaa7 0%, #fdcb6e 100%);">?</div>
                    <div class="service-content">
                        <div class="service-name">B?a s�ng buffet</div>
                        <div class="service-details">Nguy?n V?n A � Ph�ng 101</div>
                    </div>
                ...
                <div class="service-item">
                    ...
                    <div class="service-content">
                        <div class="service-name">Massage to�n th�n</div>
                        <div class="service-details">Tr?n Th? B � Ph�ng 205</div>
                    </div>
                ...
                <div class="service-item">
                    ...
                    <div class="service-content">
                        <div class="service-name">Gi?t ?i qu?n �o</div>
                        <div class="service-details">L� V?n C � Ph�ng 312</div>
                    </div>
                ...
                <div class="service-item">
                    ...
                    <div class="service-content">
                        ...
                        <div class="service-details">Ph?m Th? D � Ph�ng 108</div>
                    </div>
                    <span class="service-status status-completed">
                        <span class="status-dot"></span>
                        Ho�n th�nh
                ...
                <div class="service-item">
                    ...
                    <div class="service-content">
                        <div class="service-name">??a ra s�n bay</div>
                        <div class="service-details">Ho�ng V?n E � Ph�ng 407</div>
                    </div>
                    <span class="service-status status-waiting">
                        <span class="status-dot"></span>
                        Ch? x? l�
        ...
        <div class="footer-content">
            <div class="row">
                <div class="col-md-4 footer-section">
                    <h4>H? th?ng qu?n l� d?ch v? kh�ch s?n</h4>
                    <p>T?i ?u h�a quy tr�nh l�m vi?c v?i giao di?n th�n thi?n v� hi?u qu?.</p>
                </div>
                <div class="col-md-4 footer-section">
                    <h4>H? tr? k? thu?t</h4>
                    <ul>
