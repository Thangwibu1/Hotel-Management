        ...
        <div class="container" style="position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 90%; max-width: 700px; max-height: 90vh; overflow-y: auto; z-index: 9999;">
            ...
            <div class="modal-content shadow-lg rounded-3">
                ...
                <div class="p-4">
                    ...
                    <div class="mb-4">
                        <label for="notesArea" class="form-label text-dark fw-medium">📝 Notes</label>
                        <textarea class="form-control" id="notesArea" rows="4" placeholder="Enter notes about the room condition, damages, etc."></textarea>
                    </div>
                </div>
                ...
                <div class="p-4 border-top">
                    <div class="d-flex w-100 gap-2">
                        ...
                        <form action="#" method="POST" class="d-flex flex-fill" style="padding: 0; margin: 0;">
                            <input type="hidden" name="action" value="report">
                            <input type="hidden" name="room_id" value="<%= room%>">

                            <input type="submit" 
                                   value="⚠️ Report Issue" 
